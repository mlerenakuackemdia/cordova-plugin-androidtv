...
module.exports = function (context) {
  ...
  let banners = [
    {
      src: path.join(projectRoot, 'res', 'icon', 'android', 'banner_160x90.png'),
      dest: path.join(appSrcMainPath, 'res', 'drawable-mdpi', 'ic_banner.png'),
      density: 'mdpi'
    },
    {
      src: path.join(projectRoot, 'res', 'icon', 'android', 'banner_240x135.png'),
      dest: path.join(appSrcMainPath, 'res', 'drawable-hdpi', 'ic_banner.png'),
      density: 'hdpi'
    },
    {
      src: path.join(projectRoot, 'res', 'icon', 'android', 'banner_320x180.png'),
      dest: path.join(appSrcMainPath, 'res', 'drawable-xhdpi', 'ic_banner.png'),
      density: 'xhdpi'
    }
  ]
    banners.forEach(function (banner) {
        ...
        try {
            fs.copyFileSync(banner.src, banner.dest)
        } catch (err) {
